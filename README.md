...
> Scrape Meta Threads posts, profiles, replies without API

[![Python 3.11+](https://img.shields.io/badge/Python-3.11+-blue?style=flat-square&logo=python)](https://www.python.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green?style=flat-square)](LICENSE)
[![Stars](https://img.shields.io/github/stars/data-scrape/threads-scraper?style=flat-square)](https://github.com/data-scrape/threads-scraper)
[![Forks](https://img.shields.io/github/forks/data-scrape/threads-scraper?style=flat-square)](https://github.com/data-scrape/threads-scraper/forks)
...
**Threads Scraper** is a free, open-source Python scraper for **Meta Threads**. Extract structured data from meta threads with full pagination support, proxy rotation, and multiple export formats.

threads scraper, meta threads scraper, scrape threads
...
```bash
git clone https://github.com/data-scrape/threads-scraper.git
cd threads-scraper
...
```bash
python scraper.py "Posts from @zuck about AI"
```
...
`post_id` | `text` | `author` | `author_handle` | `created_at` | `likes` | `replies` | `reposts` | `quotes` | `media_urls` | `reply_to` | `thread_id`
